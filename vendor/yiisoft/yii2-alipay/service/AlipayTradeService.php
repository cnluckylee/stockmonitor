...
use yii\alipay\aop\request\AlipayTradeWapPayRequest;
use yii\alipay\aop\request\AlipayTradeQueryRequest;
use yii\alipay\aop\AopClient;
...
//		$this->writeLog($biz_content);
	...
	function writeLog($text) {
		...
		//$text = characet ( $text );
		file_put_contents ( "/tmp/alipaylog.txt", date ( "Y-m-d H:i:s" ) . "  " . $text . "\r\n", FILE_APPEND );
	}
